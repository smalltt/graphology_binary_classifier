...
def save_model(arg_model_json_path,arg_label_obj_path,arg_model,arg_model_weights_path,arg_model_default_save_path):
...
def plot_loss_accuracy(arg_model_fit_output, arg_nb_epochs, arg_output_folder):
