...
# refer to: https://keras.io/api/applications/convnext/#convnexttiny-function
...
def make_model(arg_input_shape, arg_num_classes):
    ...
    # For ConvNeXt, preprocessing is included in the model using a Normalization layer. ConvNeXt models expect their inputs to be float or uint8 tensors of pixels with values in the [0-255] range. 
