# This is the NASNetMobile model
# refer to: https://keras.io/api/applications/nasnet/#nasnetmobile-function
...
def make_model(arg_input_shape, arg_num_classes):
    ...
    input_tensor=None,
    input_shape=arg_input_shape,  # Optional shape tuple, only to be specified if include_top is False (otherwise the input shape has to be (224, 224, 3) for NASNetMobile It should have exactly 3 inputs channels, and width and height should be no smaller than 32.
    pooling=None,
    ...
    x = inputs
    x = keras.applications.nasnet.preprocess_input(x)  # [-1, 1]
