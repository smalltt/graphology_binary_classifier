...
train_ds, val_ds = tf.keras.utils.image_dataset_from_directory(
    directory="/usr/test/data/dataset_gra/no_split/training",  # 2classes_split_balanced/eg1_eng/split_1_2, 2classes_nosplit_balanced/eg1, 2classes_split_balanced/eg1/split_9_12/training
...
test_ds = tf.keras.utils.image_dataset_from_directory(
    directory="/usr/test/data/dataset_gra/no_split/testing",  
    batch_size=BATCH_SIZE,
    image_size=(IMAGE_SIZE, IMAGE_SIZE),
    seed=123,
...
print(classification_report(y_test, out_t))
...
# out = model.predict(x_test)
# out_bool = np.argmax(out, axis=1)

# print(classification_report(y_test, out_bool))
