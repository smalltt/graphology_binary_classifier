...
epochs = 10  # 25, 50, 100, 2000, 5000

## Split samples as training and validation datasets
train_ds, val_ds = tf.keras.utils.image_dataset_from_directory(
    directory="/usr/test/eg1_mnist/training",  # 2classes_nosplit_balanced/eg1, 2classes_split_balanced/eg2/split_6_8
...
test_ds = tf.keras.utils.image_dataset_from_directory(
    directory="/usr/test/eg1_mnist/testing",  
    batch_size=BATCH_SIZE,
    image_size=(IMAGE_SIZE, IMAGE_SIZE),
    seed=123,
